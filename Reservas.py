...
def generar_svg_calendario(instalacion, fecha, bloques, reservas):
    ...
    for disp_ini, disp_fin in disponibles:
        ...
        svg_lines.append(f'<line x1="50" y1="{y_inicio}" x2="{ancho + 30}" y2="{y_inicio}" stroke="#4caf50" stroke-width="1" stroke-dasharray="3,3"/>')
        svg_lines.append(f'<text x="60" y="{y_inicio + 14}" class="bloque-text" style="fill: #2e7d32; font-size: 11px;">✅ {duracion_str}</text>')
